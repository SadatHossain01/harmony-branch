<script lang="ts">
  ...
  import type { UserHandle } from "../lib/data/user";
  //  import { loadUserHandles } from "../lib/data/user";
  ...
  users = [
    { id: "1", user_name: "sadat999" },
    { id: "2", user_name: "risenfromashes" },
    { id: "3", user_name: "pumpa" },
    { id: "4", user_name: "siam11651" },
    { id: "5", user_name: "mahabhu" },
    { id: "6", user_name: "imanik" },
    { id: "7", user_name: "ishrak26" },
    { id: "8", user_name: "mahirlabibdihan" },
    { id: "9", user_name: "shattik420" },
    { id: "10", user_name: "msh" },
    { id: "11", user_name: "brainiac77" },
    { id: "12", user_name: "thecodeheist" },
    { id: "13", user_name: "recklessraccoon" },
    { id: "14", user_name: "mijan_rmn" },
    { id: "15", user_name: "nahinkhan" },
    { id: "16", user_name: "nafi10" },
    { id: "17", user_name: "monke" },
    { id: "18", user_name: "saffatjabin" },
    { id: "19", user_name: "nabid" },
    { id: "20", user_name: "aniksaha" },
  ];
